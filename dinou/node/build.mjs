...
// Pass A: RSC Engine (conditions: ["node", "worker", "react-server"])
// Pass B: Native Streaming HTML SSR Engine (conditions: ["node", "worker", "browser"])
...
console.log("⚡ [Dinou Node] Generating static route modules...");
...
// ====================================================================
console.log("🔍 [Dinou Node] Discovering client components for SSR Engine...");
...
console.log("⚡ [Dinou Node] Building in-memory VFS for routing...");
const vfsSnapshot = {};
...
// Generate ssr-client-manifest.mjs
...
try {
  // Pass A: RSC Engine
  console.log("🚀 [Dinou Node] Bundling Pass A: RSC Engine (conditions: react-server)...");
  await esbuild.build({
  ...
  // Pass B: SSR Engine
  console.log("🚀 [Dinou Node] Bundling Pass B: Native SSR Engine (conditions: browser)...");
  await esbuild.build({
  ...
  console.log("🚀 [Dinou Node] Bundling Pass C: Node Orchestrator (server.js)...");
  await esbuild.build({
